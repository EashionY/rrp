				   ...
				   $.each(result.data,function(k,v){
					   ...
					   if(window.screen.width<1024){
						   str1='<div class="delivery_leftcontbox"><div class="delivery_leftcontmain">'+
						       ...
						       '<div class="delivery_leftcontdiv2"><div><div>申请：</div><span class="delivery_div2_span1">'+v.resumeName+'</span></div><div><div>投递成功 </div>';
					   }else{
						   str1='<div class="delivery_leftcontbox"><div class="delivery_leftcontmain">'+
							   '<div class="delivery_leftcontdiv1"><div class="delivery_leftcomname">'+v.companyName+'</div>'+
							   '<div>'+v.postName+'<span class="delivery_leftadd">['+v.region+']</span></div>'+
							   '<div class="delivery_leftsala">'+v.salary+'</div></div>'+
							   '<div class="delivery_leftcontdiv2"><div>申请：<span class="delivery_div2_span1">'+v.resumeName+'</span></div><div><span>投递成功 </span>';
					   }
					   var str2='<span class="delivery_div2_time">'+new Date(v.delivery_time).format("yyyy-MM-dd hh:mm")+'</span><span class="myfont delivery_div2_font">&#xe681;</span></div></div>'+
	                   ...
	                   '<div class="delivery_time">'+new Date(v.delivery_time).format("yyyy-MM-dd hh:mm")+'</div><div class="delivery_time"><span class="delivery_tip"></span>HR已收到你的简历</div>'+
