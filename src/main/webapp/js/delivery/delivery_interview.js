			   ...
			   if(result.data.length!=0){
				   ...
				   $.each(result.data,function(k,v){
					   ...
					   if(window.screen.width<1024){
	                    ...
	                    '<div class="delivery_state">对我有意</div><div class="delivery_time">'+new Date(v.intend_time).format("yyyy-MM-dd hh:mm")+'</div><div class="delivery_time">'+
