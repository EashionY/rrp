			   ...
			   if(result.data.length!=0){
				   ...
				   $.each(result.data,function(k,v){
					   ...
					   if(window.screen.width<1024){
					       ...
					       '<div class="delivery_leftcontdiv2"><div><div>申请：</div><span class="delivery_div2_span1">'+v.resumeName+'</span></div><div><div>对我有意 </div>';
					   }else{
						   str1='<div class="delivery_leftcontbox"><div class="delivery_leftcontmain"><div class="delivery_leftcontdiv1">'+
	                        ...
	                        var str2='<span class="delivery_div2_time">'+new Date(v.intend_time).format("yyyy-MM-dd hh:mm")+'</span><span class="myfont delivery_div2_font">&#xe681;</span></div></div>'+
